...
| 2026-05-09 | H4-followup deferred; M1 dead-code removal | e51471c | H4-followup: DEFERRED (Cameras.svelte WIP constraint); M1: 0 B delta (esbuild already tree-shook the 4 dead exports; removed for hygiene) |
