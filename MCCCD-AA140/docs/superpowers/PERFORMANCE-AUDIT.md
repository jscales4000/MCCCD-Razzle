...
| 2026-05-20 | H4-followup per-page signal gating | a24903d | 27 subs moved to per-page onMount/onDestroy; initSignals 37→10 always-on; index JS +349 B (gating bodies); runtime: −27 crcomlib registry slots at idle |
