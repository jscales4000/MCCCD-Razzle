...
| 2026-06-24 | H4-followup per-page signal gating | 21d62a9 | 16 subscriptions moved from always-on to per-page mount/destroy; index-*.js +348 B for scaffolding; runtime: 16 fewer idle crcomlib slots |
