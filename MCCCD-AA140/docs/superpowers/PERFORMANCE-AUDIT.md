...
| 2026-05-11 | H4-followup per-page routing+mixer state gating | b47e38c | index.js +269 B (gating logic); 4 fewer always-on subscriptions; camTrackingModeFb stays global (Cameras WIP) |
