...
| 2026-06-11 | H4-followup per-page signal gating | 95b8500 | 25 subscriptions removed from boot; initSignals() 34→9; index-*.js +223 B, AudioMixer-*.js -490 B, net JS −172 B |
