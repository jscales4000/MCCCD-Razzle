...
| 2026-06-19 | H4-followup per-page signal gating | 6546f46 | 21 subscriptions removed from always-on; JS -503 B net (mixed with 3-week feature delta); camTrackingModeFb left always-on (Cameras.svelte protected) |
