...
| 2026-06-22 | H4-followup gate low-freq state signals | 1a5cedd | 16 subscriptions removed from always-on init (2 routing + 14 AudioMixer ceiling/state); index JS 76,699 B |
