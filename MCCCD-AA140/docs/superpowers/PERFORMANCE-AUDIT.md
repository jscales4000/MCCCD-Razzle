...
| 2026-07-01 | H4-followup gate low-freq signals | e24ce2e | 16 subscriptions gated (2 routing → DisplayRouting, 14 mixer state → AudioMixer); ~neutral bundle; 16 fewer boot-time crcomlib refs |
