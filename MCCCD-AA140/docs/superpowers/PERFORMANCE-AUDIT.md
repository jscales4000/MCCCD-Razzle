...
| 2026-05-14 | H4-followup per-page signal gating (partial) | 284de32 | 16 subs moved: 2→DisplayRouting, 14→AudioMixer; initSignals() 37→21; index.js +301 B, index.css +115 B (gate-fn overhead) |
