...
| 2026-05-30 | H4-followup gate routing+scene/link signals | d0179e0 | 8 subscriptions removed from initSignals(); index-*.js 77,221 → 77,020 B (-201 B); 4 dead Ceiling3 subs removed |
