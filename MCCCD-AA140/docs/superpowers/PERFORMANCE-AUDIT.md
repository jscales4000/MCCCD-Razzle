...
| 2026-06-10 | H4-followup per-page state signals | 3efed93 | initSignals 36→16 subs at boot; +398 B gating overhead (expected); 21 runtime subs deferred to page mount |
