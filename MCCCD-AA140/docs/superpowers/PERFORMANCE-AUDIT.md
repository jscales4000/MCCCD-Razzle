...
| 2026-06-17 | H4-followup per-page state signal gating | 9ac5e04 | 23 subscriptions moved to per-page gates; initSignals() 39→16 always-on; index JS +348 B (teardown machinery cost) |
