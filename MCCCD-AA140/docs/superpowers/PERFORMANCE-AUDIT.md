...
| 2026-06-03 | H4-followup dead-signal purge + routing gate (scoped) | 8326c5f | −5 dead micCeiling3 stores/subs; routingModeFb+autoRouteEnableFb now lazy via DisplayRouting onMount/onDestroy; index JS −470 B |
