...
<script lang="ts">
  ...
  // Per-audit H4: level meters and AudioMixer-only state signals are subscribed
  // lazily so they don't sit in the CrComLib registry when the page is unmounted.
